...
def get_args():
    parser = argparse.ArgumentParser(description="DCEL Args")
    ######################## general settings ########################
    parser.add_argument("--local_rank", default=0, type=int)
    parser.add_argument("--name", default="baseline+unc", help="experiment name to save")
    ...
    ######################## loss settings ########################
    parser.add_argument("--loss_names", default='sdm+id+mlm+unc+sdm_loc', help="which loss to use ['mlm', 'cmpm', 'id', 'itc', 'sdm']")
    ...
    parser.add_argument("--lrscheduler", type=str, default="linear")
